...
public class ModRecipes {
    ...
    public static class ConstructionTable {
        ...
        static void registerConstructionTableRecipes() {
            ...
            ConversionEffectStone = registerRecipe(new ItemStack(ModItems.EffectStone, 1, ItemEffectStone.EnumStoneEffects.Conversion.ordinal()), obj(new ItemStack(ModItems.EffectStone, 1, ItemEffectStone.EnumStoneEffects.None.ordinal()), DUST_REDSTONE, DUST_GLOWSTONE), obj(NETHER_QUARTZ, NETHER_QUARTZ), true, false);
            ...
            Levitator = registerRecipe(new ItemStack(ModBlocks.Levitator), obj(null, ModBlocks.TintedLog, null, ModBlocks.TintedLog, ModItems.HalfPearl, ModBlocks.TintedLog, DUST_REDSTONE, ModBlocks.TintedLog, DUST_REDSTONE), obj(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Motion.ordinal())), false, true);
            ...
            Impeller = registerRecipe(new ItemStack(ModBlocks.Impeller), obj(null, Blocks.STONE_SLAB, null, Blocks.STONE_SLAB, new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Motion.ordinal()), Blocks.STONE_SLAB, null, Blocks.STONE_SLAB, null), obj(Blocks.REDSTONE_TORCH, Blocks.REDSTONE_TORCH), false, false);
    ...
    public static class WandInteraction {
        ...
        static void registerWandInteractions() {
            ...
            MotionCore = registerItemRecipe(stack(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Motion.ordinal())), TransmutationStructure.EMPTY, obj(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Blank.ordinal()), new ItemStack(ModItems.HalfPearl), FEATHER), obj(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Blank.ordinal()), new ItemStack(ModItems.HalfPearl, 1), FEATHER), false, 1);
            StorageCore = registerItemRecipe(stack(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Storage.ordinal())), TransmutationStructure.EMPTY, obj(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Blank.ordinal()), new ItemStack(Blocks.CHEST), new ItemStack(Blocks.HOPPER)), obj(new ItemStack(ModItems.Core, 1, ItemCore.EnumTypes.Blank.ordinal()), new ItemStack(Blocks.CHEST), new ItemStack(Blocks.HOPPER)), false, 1);
